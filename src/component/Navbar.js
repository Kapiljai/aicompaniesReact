...
class Navbar extends Component {
    ...
    handleTabChange(tabIndex) {
        ...
        console.log("Current active tab:", this.state.activeTab);
    }
                ...
                <div className="container-fluid">
                    <div className="page-main-content">
                                ...
                                <ul className="nav-tabs-links">
                                    <li>
                                        <a
                                            ...
                                            onClick={(e) => {
                                                ...
                                                this.handleTabChange('ai_companies');
                                            }}
                                        >
                                            AI Companies
                                        </a>
                                    ...
                                    <li>
                                        <a
                                            ...
                                            onClick={(e) => {
                                                e.preventDefault();
                                                this.handleTabChange('ai_services');
                                            }}
                                        >
                                            Service
                                        </a>
                        ...
                        <div className="user-icon-profile">
                            ...
                            <li><a href="/" className="mt-1">Sign Up</a></li>
                            <li><a href="/" className="mt-1">Profile Icon</a></li>
